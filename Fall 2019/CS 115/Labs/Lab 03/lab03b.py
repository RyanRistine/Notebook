...
def main():
    window = GraphWin('Lab 3a_2', 400, 600)
    ...
    pink_top_left = Point(palette_top_left_x + width, palette_top_left_y)
    pink_bottom_right = Point(palette_top_left_x + 2 * width, palette_top_left_y + height)
    pink_rectangle = Rectangle(pink_top_left, pink_bottom_right)
    pink_rectangle.setFill('pink')
    pink_rectangle.draw(window)

    blue_top_left = Point(palette_top_left_x + 2 * width, palette_top_left_y)
    blue_bottom_right = Point(palette_top_left_x + 3 * width, palette_top_left_y + height)
